...
export default function AboutPage() {
  return (
    <div className="text-[var(--primary-text)] mb-14 lg:mb-20">
      ...
      <div className="flex flex-col gap-16 lg:gap-24">
        <div className="flex flex-col gap-4 lg:gap-6">
          ...
          <div className="flex flex-col gap-4">
            <h1 className="font-playfair-bold text-xl md:text-2xl md:max-w-xl lg:text-3xl lg:max-w-2xl">
              Your trusted destination for discovering, buying, and falling in
              love with books.
            </h1>
            <p className="font-lora-regular text-sm leading-[1.5] md:text-md md:max-w-xl lg:max-w-2xl lg:leading-[1.7]">
        ...
        <div className="flex flex-col gap-8 md:gap-12">
          <div className="flex flex-col gap-2 md:flex-row md:gap-6">
            ...
            <div className="flex flex-col md:w-1/2 md:gap-2">
              <h1 className="font-playfair-bold text-xl md:text-2xl lg:text-3xl">Our Vision</h1>
              <p className="font-lora-regular text-sm lg:text-md lg:leading-[1.5]">
          ...
          <div className="flex flex-col gap-2 md:flex-row-reverse">
            ...
            <div className="flex flex-col md:w-1/2 md:gap-2">
              <h1 className="font-playfair-bold text-xl md:text-2xl lg:text-3xl">Our Mission</h1>
              <p className="font-lora-regular text-sm lg:text-md lg-leading-[1.5]">
                We envision a future where books are not a luxury but a
                lifestyle, empowering people to learn, grow, and connect through
                the power of stories and information.
